...
public class Maps5 extends FragmentActivity implements OnMapReadyCallback {
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    supportMapFragment.getMapAsync(Maps5.this);
                }
            }
        });
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng bnglatLng6 = new LatLng(12.959684,77.599077);
        MarkerOptions markerOptions6 = new MarkerOptions().position(bnglatLng13);
        googleMap.addMarker(markerOptions6);
        LatLng bnglatLng7 = new LatLng(12.963503,77.584207);
        MarkerOptions markerOptions7 = new MarkerOptions().position(bnglatLng13);
        googleMap.addMarker(markerOptions7);
        LatLng bnglatLng8 = new LatLng(12.911403,77.644497);
        MarkerOptions markerOptions8 = new MarkerOptions().position(bnglatLng13);
        googleMap.addMarker(markerOptions8);
        LatLng bnglatLng9 = new LatLng(12.8994828, 77.5610398);
        MarkerOptions markerOptions9 = new MarkerOptions().position(bnglatLng7);
        googleMap.addMarker(markerOptions9);
        LatLng bnglatLng10 = new LatLng(12.9054360, 77.5561820);
        MarkerOptions markerOptions10 = new MarkerOptions().position(bnglatLng8);
